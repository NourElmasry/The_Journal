...
namespace The_Journal.Controllers
{
    public class EmergencyContactsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmergencyContactID,FirstName,LastName,MobileNum,Relationship")] EmergencyContact emergencyContact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmergencyContactID,FirstName,LastName,MobileNum,Relationship")] EmergencyContact emergencyContact)
        {
            if (ModelState.IsValid)
            {
